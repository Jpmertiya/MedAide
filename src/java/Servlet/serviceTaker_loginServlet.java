 ...
 * @author js594
 */
public class serviceTaker_loginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet serviceTaker_loginServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            serviceTaker_userDao userdao=new serviceTaker_userDao(connectionProvider.getConnection());
            
             //object of user
             serviceTaker users=userdao.getUserByEmailAndPassword(userEmail, userPassword);
             if (users == null) {
