                    ...
                    <div class="login-html">
                        ...
                        <div class="login-form">
                            ...
                            <div class="sign-in-htm" style="margin-top: 30px;">
                                <form action="serviceTaker_loginServlet" method="POST">
                                    <h2 class="stlogin">User Login</h2>
                                    <div class="group">
                                    ...
                                    <div class="hr"></div>
                                    <div class="foot-lnk">
                                        <a href="sign.jsp">Create Account?</a>
                                    </div>
                                </form>
                            </div>
                            <div class="sign-up-htm" style="margin-top: 30px;"  >
